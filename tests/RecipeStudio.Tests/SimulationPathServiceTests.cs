...
public sealed class SimulationPathServiceTests
{
    ...
    public void Build_WithSmoothMotion_CreatesArcMap()
    {
        ...
        {
            new() { Act = true, Safe = true, Xr0 = 0, Yx0 = 0, Zr0 = 0, NozzleSpeedMmMin = 120 },
            new() { Act = true, Safe = true, Xr0 = 20, Yx0 = 20, Zr0 = 40, NozzleSpeedMmMin = 120 },
            new() { Act = true, Safe = true, Xr0 = 40, Yx0 = 0, Zr0 = 80, NozzleSpeedMmMin = 120 }
        };
